...
const registerUser = async (req, res) => {
    try {
        ...
        if (!validator.isValid(shipping)) return res.status(400).send({ status: false, message: 'please provide shipping Address'})
        if (!validator.isValid(shipping.street)) return res.status(400).send({ status: false, message: 'please provide shipping street' })
        if (!validator.isValid(shipping.city)) return res.status(400).send({ status: false, message: 'please provide shipping city' })
        if (!validator.isValid(shipping.pincode)) return res.status(400).send({ status: false, message: 'please provide shipping pincode' })
        if (!validator.isValidPincode(shipping.pincode)) return res.status(400).send({ status: false, message: 'please provide shipping pincode in digits' })

        if (!validator.isValid(billing)) return res.status(400).send({ status: false, message: 'please provide billing Address'})
        if (!validator.isValid(billing.street)) return res.status(400).send({ status: false, message: 'please provide billing street' })
        if (!validator.isValid(billing.city)) return res.status(400).send({ status: false, message: 'please provide billing city' })
        if (!validator.isValid(billing.pincode)) return res.status(400).send({ status: false, message: 'please provide billing pincode' })
        if (!validator.isValidPincode(billing.pincode)) return res.status(400).send({ status: false, message: 'please provide billing pincode in digits' })
